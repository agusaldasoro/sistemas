...
Dado que cuando una tarea se bloquea es desalojada para que otra disponible comience a ejecutarse, cuando el bloque de la misma termina se la vuelve a encolar como una tarea disponible para ser ejecutada en su debido momento. 
\bigskip 
...
\bigskip 
 \textcolor{red}{Estos diagramas cambiaron, fijarse que siga estando bien la expliccion}
